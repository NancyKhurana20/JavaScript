...
//in objects order doesnot matter so we do not need to skip any elements
const {name,openingHours,categories}=restaurant;
console.log(name,openingHours,categories);

//If we want variable name different as property names
const {name:restaurantName,openingHours:hours,categories:tags}=restaurant;
console.log(restaurantName,hours,tags);

//Default values
const {menu = [],starterMenu:starters=[]}=restaurant;
console.log(menu,starters); //menu doesnot exists in the restaurant so instead of menu we will get an empty array

//Mutating the variable (swapping)
let a=111;
let b=999;
...
console.log(fri); // but we want open and close seperately
